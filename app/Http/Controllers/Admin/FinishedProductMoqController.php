<?php
/**
 * Class FinishedProductMoq
 * @property \App\FinishedProductMoq $model
 */

namespace App\Http\Controllers\Admin;

use App\FinishedProductMoq;
use Breadcrumb;
...
class FinishedProductMoqController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method FinishedProductMoq index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'finished_product_moqs.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "finished_product_moqs.id
, finished_product_moqs.date
, finished_product_moqs.schedule as upload_document 
, finished_product_moqs.status
, finished_product_moqs.created_at
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_product_moqs form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_product_moqs store | Insert & Update
     * *****************************************************************************************************************
     */
