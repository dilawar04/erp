<?php
/**
 * Class MachineCriticalPart
 * @property \App\MachineCriticalPart $model
 */

namespace App\Http\Controllers\Admin;

use App\MachineCriticalPart;
use Breadcrumb;
...
class MachineCriticalPartController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'machine_critical_parts.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "machine_critical_parts.id
, machine_critical_parts.part_name
, machine_critical_parts.part_type
, machine_critical_parts.part_life
, machine_critical_parts.status
, machine_critical_parts.created_at

    ";
        $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('machines', 'machines.id', '=', 'machine_critical_parts.machine_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method machine_critical_parts form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method machine_critical_parts store | Insert & Update
     * *****************************************************************************************************************
     */
