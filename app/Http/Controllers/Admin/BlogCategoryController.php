...
class BlogCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        , IFNULL(parent_blog_categories.category, '/') AS parent
        , blog_categories.image
        , blog_categories.status
    ";
        $SQL = $this->model->select(\DB::raw($select));

        $SQL = $SQL->leftJoin('blog_categories as parent_blog_categories', 'parent_blog_categories.id', '=', 'blog_categories.parent_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
