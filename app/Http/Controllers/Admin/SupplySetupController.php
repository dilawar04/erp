...
/**
 * Class SupplySetup
 * @property \App\SupplySetup $model
 */
...
class SupplySetupController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'supply_setups.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "supply_setups.id
        , supply_setups.have_delivery_station
        , supply_setups.station_name
        , supply_setups.station_code
        , supply_setups.created_at
 ";
    ...
    public function store()
    {
        ...
        /** -------- Validation */
        $validator_rules = [
            'no_of_station' => "required",
            'have_delivery_station' => "required",
