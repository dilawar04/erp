<?php
/**
 * Class FinishedProductOperation
 * @property \App\FinishedProductOperation $model
 */

namespace App\Http\Controllers\Admin;

use App\FinishedProductOperation;
use Breadcrumb;
...
class FinishedProductOperationController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method ImportDeliveryOrder index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'finished_product_operations.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "finished_product_operations.id
, finished_product_operations.opening_quantity
, finished_product_operations.line
, finished_product_operations.type_id
, finished_product_operations.status
, finished_product_operations.created_at


    ";
        $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('oems', 'oems.id', '=', 'finished_product_operations.oem_id');
        /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_product_operations form
     * *****************************************************************************************************************
     */
