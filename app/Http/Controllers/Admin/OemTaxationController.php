...
class OemTaxationController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'oem_taxations.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "oem_taxations.id
, oem_taxations.ntn
, oem_taxations.sales_tax
, oem_taxations.status
, oem_taxations.created_at
    ";
