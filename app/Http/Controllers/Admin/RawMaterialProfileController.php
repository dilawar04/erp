 ...
 * @property \App\RawMaterialProfile $model
 */

namespace App\Http\Controllers\Admin;

use App\RawMaterialProfile;
use Breadcrumb;
...
class RawMaterialProfileController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method raw_material_images index | Grid | listing
     * *****************************************************************************************************************
     */
    /**
     * *****************************************************************************************************************
     * @method raw_material_profiles index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'raw_material_profiles.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "raw_material_profiles.id
, raw_material_profiles.material_code
, raw_material_profiles.name
...
, raw_material_profiles.created_at
    ";
        ...
        //$SQL = $SQL->leftJoin('users', 'users.id', '=', 'oem.user_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
