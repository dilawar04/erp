...
/**
 * Class ShiftOvertime
 * @property \App\ShiftOvertime $model
 */
...
class ShiftOvertimeController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method shift_overtimes index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'shift_overtimes.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "shift_overtimes.id
, shift_overtimes.shift_name
, shift_overtimes.start_time
, shift_overtimes.end_time
, shift_overtimes.late_till
, shift_overtimes.half_day_from
, shift_overtimes.b_name
, shift_overtimes.b_from
, shift_overtimes.b_till
, shift_overtimes.days
 ";
    ...
    /**
     * *****************************************************************************************************************
     * @method shift_overtimes store | Insert & Update
     * *****************************************************************************************************************
     */
