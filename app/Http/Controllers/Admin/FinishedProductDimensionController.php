<?php
/**
 * Class FinishedProductDimension
 * @property \App\FinishedProductDimension $model
 */

namespace App\Http\Controllers\Admin;

use App\FinishedProductDimension;
use Breadcrumb;
...
class FinishedProductDimensionController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method FinishedProductDimension index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'finished_product_dimensions.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "finished_product_dimensions.id
, finished_product_dimensions.item
, finished_product_dimensions.value
, finished_product_dimensions.tolerance
, finished_product_dimensions.type_id
, finished_product_dimensions.method
, finished_product_dimensions.sampling_criteria
, finished_product_dimensions.sample_size
, finished_product_dimensions.remarks
, finished_product_dimensions.status
, finished_product_dimensions.created_at

    ";
           $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('types', 'types.id', '=', 'finished_product_dimensions.type_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_product_dimensions form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_product_dimensions store | Insert & Update
     * *****************************************************************************************************************
     */
