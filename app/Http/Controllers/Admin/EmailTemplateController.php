...
/**
 * Class EmailTemplate
 * @property \App\EmailTemplate $model
 */
...
class EmailTemplateController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => "{$this->table}.{$this->id_key}"])->merge(request()->query())->toArray();
...
, email_templates.subject
    ...
    ";
        ...
        //$SQL = $SQL->leftJoin('languages', 'languages.id', '=', 'email_templates.lang_code');
    ...
    /**
     * *****************************************************************************************************************
     * @method email_templates store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        /** -------- Validation */
        $validator_rules = [
            'name' => "required|unique:{$this->table},name,{$id},{$this->id_key}",
            'subject' => "required",
        ];
    ...
    /**
     * *****************************************************************************************************************
     * @method email_templates duplicate
     * *****************************************************************************************************************
     */
