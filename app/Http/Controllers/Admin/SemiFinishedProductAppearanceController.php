<?php
/**
 * Class SemiFinishedProductAppearance
 * @property \App\SemiFinishedProductAppearance $model
 */

namespace App\Http\Controllers\Admin;

use App\SemiFinishedProductAppearance;
use Breadcrumb;
...
class SemiFinishedProductAppearanceController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method semi_finished_product_appearance index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'semi_finished_product_appearances.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "semi_finished_product_appearances.id
, semi_finished_product_appearances.item
, semi_finished_product_appearances.criteria
, semi_finished_product_appearances.sampling_criteria
, semi_finished_product_appearances.sample_size
, semi_finished_product_appearances.status

";
        $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('oems', 'oems.id', '=', 'semi_finished_product_appearances.oem_id');
        /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method import_delivery_orders form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method import_delivery_orders store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        /** -------- Upload Files */
        $files = upload_files(['schedule'], "assets/front/{$this->table}/");
        if (count($files) > 0) {
    ...
    /**
     * *****************************************************************************************************************
     * @method semi_finished_product_appearances delete
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method designations view | Record
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method designations AJAX actions
     * *****************************************************************************************************************
     */
    function ajax()
    {
