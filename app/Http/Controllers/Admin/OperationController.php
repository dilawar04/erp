...
class OperationController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method operations index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'operations.' . $this->id_key])->merge(request()->query())->toArray();
...
, operations.created_at
    ...
    ";
        ...
        //$SQL = $SQL->leftJoin('users', 'users.id', '=', 'operations.user_id');
        /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method operations store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        /** -------- Upload Files */
         ...
         if (count($id) > 1) {
            foreach ($operation as $name => $operation) {
                if ($operation) {
                    $data['data'][$name] = $operation->getFilename();
                                           // $office_data = DB_FormFields($this->model, [], $item);
                        $operation_data['data']['operation_id'] = $id;
                        $operation_data['data']['operation_code'] = $operation_code;
                        $operation_data['data']['operation_name'] = $operation_name;
                        save($this->table, $operation_data['data']);
    ...
    /**
     * *****************************************************************************************************************
     * @method operations AJAX actions
     * *****************************************************************************************************************
     */
    function ajax()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method work_stations duplicate
     * *****************************************************************************************************************
     */
