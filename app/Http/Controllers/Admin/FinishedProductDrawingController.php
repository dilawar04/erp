<?php
/**
 * Class FinishedProductDrawing
 * @property \App\FinishedProductDrawing $model
 */

namespace App\Http\Controllers\Admin;

use App\FinishedProductDrawing;
use Breadcrumb;
...
class FinishedProductDrawingController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'finished_product_drawings.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "finished_product_drawings.id
, finished_product_drawings.upload_document
, finished_product_drawings.upload_date
, finished_product_drawings.status
, finished_product_drawings.created_at
    ";
    ...
    /**
     * *****************************************************************************************************************
     * @method semi_finished_product_drawings form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method semi_finished_product_drawings store | Insert & Update
     * *****************************************************************************************************************
     */
