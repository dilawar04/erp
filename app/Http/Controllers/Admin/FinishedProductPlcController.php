<?php
/**
 * Class FinishedProductPlc
 * @property \App\FinishedProductPlc $model
 */

namespace App\Http\Controllers\Admin;

use App\FinishedProductPlc;
use Breadcrumb;
...
class FinishedProductPlcController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method FinishedProductplc index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'finished_product_plcs.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "finished_product_plcs.id
, finished_product_plcs.date
, finished_product_plcs.schedule as upload_document 
, finished_product_plcs.status
, finished_product_plcs.created_at
