...
class SkillManagementEmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'departments.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "departments.id
, IFNULL(parent_departments.title, 'Main') AS parent
, departments.title
, departments.status
    ...
    ";
        ...
        $SQL = $SQL->leftJoin('departments as parent_departments', 'parent_departments.id', '=', 'departments.parent_id');
