...
/**
 * Class QualitySetup
 * @property \App\QualitySetup $model
 */

namespace App\Http\Controllers\Admin;

use App\QualitySetup;
use Breadcrumb;
...
class QualitySetupController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method quality_setups index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'quality_setups.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "quality_setups.id
, quality_setups.product_id
-- , products.product_id
, quality_setups.workstation_id
-- , workstations.workstation_id
, quality_setups.opration_id
-- , oprations.opration_id
, quality_setups.quality_defect_id
-- , quality_defects.quality_defect_id
, quality_setups.material_id
-- , raw_material_categories.material_id
, quality_setups.status

    ";
        $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('products', 'products.id', '=', 'quality_setups.product_id');
                //$SQL = $SQL->leftJoin('workstations', 'workstations.id', '=', 'quality_setups.workstation_id');
                //$SQL = $SQL->leftJoin('oprations', 'oprations.id', '=', 'quality_setups.opration_id');
                //$SQL = $SQL->leftJoin('quality_defects', 'quality_defects.id', '=', 'quality_setups.quality_defect_id');
                //$SQL = $SQL->leftJoin('raw_material_categories', 'raw_material_categories.id', '=', 'quality_setups.material_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method quality_setups store | Insert & Update
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method quality_setups view | Record
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method quality_setups AJAX actions
     * *****************************************************************************************************************
     */
    function ajax()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method quality_setups duplicate
     * *****************************************************************************************************************
     */
