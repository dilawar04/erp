<?php
/**
 * Class FinishedPisProduct
 * @property \App\FinishedPisProduct $model
 */

namespace App\Http\Controllers\Admin;

use App\FinishedPisProduct;
use Breadcrumb;
...
class FinishedPisProductController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_pis_products index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'finished_pis_products.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "finished_pis_products.id
, finished_pis_products.date as upload_date
, finished_pis_products.schedule as upload_document 
, finished_pis_products.status
, finished_pis_products.created_at
