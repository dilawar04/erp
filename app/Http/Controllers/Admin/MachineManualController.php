...
/**
 * Class MachineManual
 * @property \App\MachineManual $model
 */

namespace App\Http\Controllers\Admin;

use App\MachineManual;
use Breadcrumb;
...
class MachineManualController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method machine_manuals index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'machine_manuals.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "machine_manuals.id
, machine_manuals.manual_type
, machine_manuals.file
, machine_manuals.status
, machine_manuals.created_at

    ";
        $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('machines', 'machines.id', '=', 'machine_manuals.machine_id');
        /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method machine_manuals store | Insert & Update
     * *****************************************************************************************************************
     */
    ...
    public function delete()
    {
        ...
        $unlink = ['file' => "assets/front/{$this->table}",
        ];
    ...
    /**
     * *****************************************************************************************************************
     * @method machine_manuals view | Record
     * *****************************************************************************************************************
     */
    public function view()
    {
        ...
        $config['image_fields'] = [
            'file' => ['path' => asset_url("{$this->module}"), 'size' => '128x128'],
        ];
        $config['attributes'] = [
            'id' => ['title' => 'ID'],
    ...
    /**
     * *****************************************************************************************************************
     * @method machine_manuals AJAX actions
     * *****************************************************************************************************************
     */
    function ajax()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method machine_manuals duplicate
     * *****************************************************************************************************************
     */
    ...
    public function file_upload()
    {
        ...
        $files = upload_files(['file'], $dir, ['ext' => 'gif,jpg,jpeg,png']);
        if (count($files) > 0) {
            foreach ($files as $name => $file) {
                if ($file) {
