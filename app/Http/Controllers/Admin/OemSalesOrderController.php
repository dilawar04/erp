...
class OemSalesOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'oem_sales_orders.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "oem_sales_orders.id
, oem_sales_orders.po
, oem_sales_orders.from
, oem_sales_orders.till
, oem_sales_orders.finished_product_id
, oem_sales_orders.status
, oem_sales_orders.created_at
    ";
