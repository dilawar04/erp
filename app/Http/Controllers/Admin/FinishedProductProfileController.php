<?php
/**
 * Class FinishedProductProfile
 * @property \App\FinishedProductProfile $model
 */

namespace App\Http\Controllers\Admin;

use App\FinishedProductProfile;
use Breadcrumb;
...
class FinishedProductProfileController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method FinishedProductProfile index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'finished_product_profiles.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "finished_product_profiles.id
, finished_product_profiles.product_code
, finished_product_profiles.product_name
, finished_product_profiles.code_oem  
, finished_product_profiles.part_name_oem  
, finished_product_profiles.part_no_oem 
, finished_product_profiles.type_id
, finished_product_profiles.man_min
, finished_product_profiles.safety_stock
, finished_product_profiles.quantity_pack
, finished_product_profiles.line
, finished_product_profiles.production_capacity_day
, finished_product_profiles.sequence
, finished_product_profiles.oem_model_id
, finished_product_profiles.station
, finished_product_profiles.dc_type
, finished_product_profiles.oem_man_min
, finished_product_profiles.sale_price
, finished_product_profiles.wip_bin
, finished_product_profiles.store_id
, finished_product_profiles.storage_level_1
, finished_product_profiles.storage_level_2
, finished_product_profiles.location
, finished_product_profiles.status
, finished_product_profiles.created_at
    ";
        $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('types', 'types.id', '=', 'finished_product_profiles.type_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_product_profiles form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method finished_product_profiles store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        $validator_rules = [
                ...
                'production_capacity_day' => "required",
    ...
    public function view()
    {
        ...
        $config['hidden_fields'] = ['created_by', 'deleted_at'];
        $config['image_fields'] = [
        ];
        $config['attributes'] = [
            'id' => ['title' => 'ID'],
