...
/**
 * Class Designation
 * @property \App\Designation $model
 */
...
class DesignationController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method designations index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'designations.' . $this->id_key])->merge(request()->query())->toArray();
...
, designations.status
    ...
    ";
        ...
        //$SQL = $SQL->leftJoin('departments', 'departments.id', '=', 'designations.department_id');
        /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method designations store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        /** -------- Upload Files */
        $files = upload_files(['job_description'], "assets/front/{$this->table}/");
        if (count($files) > 0) {
