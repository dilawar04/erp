<?php
/**
 * Class GenerateOemSchedule
 * @property \App\GenerateOemSchedule $model
 */

namespace App\Http\Controllers\Admin;

use App\GenerateOemSchedule;
use Breadcrumb;
...
class GenerateOemScheduleController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method workstations index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'generate_oem_schedules.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "generate_oem_schedules.id
, generate_oem_schedules.month
, generate_oem_schedules.year
...
, generate_oem_schedules.created_at
    ...
    ";
        ...
        $SQL = $SQL->leftJoin('oems', 'oems.id', '=', 'generate_oem_schedules.oem_id');
        //$SQL = $SQL->leftJoin('users', 'users.id', '=', 'generate_oem_schedules.user_id');
        /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method generate_oem_schedules form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method workstations store | Insert & Update
     * *****************************************************************************************************************
     */
