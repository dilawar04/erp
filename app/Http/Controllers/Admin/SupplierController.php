...
class SupplierController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method suppliers index | Grid | listing
     * *****************************************************************************************************************
     */
...
, suppliers.created_at
    ...
    /**
     * *****************************************************************************************************************
     * @method suppliers store | Insert & Update
     * *****************************************************************************************************************
     */
    public function store()
    {
        ...
        /** -------- Upload Files */
        $files = upload_files(['contract_document'], "assets/front/{$this->table}/");
        if (count($files) > 0) {
