<?php
/**
 * Class SemiFinishedProductStock
 * @property \App\SemiFinishedProductStock $model
 */

namespace App\Http\Controllers\Admin;

use App\SemiFinishedProductStock;
use Breadcrumb;
...
class SemiFinishedProductStockController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method semi_finished_product_stocks index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'semi_finished_product_stocks.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "semi_finished_product_stocks.id
, semi_finished_product_stocks.opening_quantity
, semi_finished_product_stocks.stock_rate
, semi_finished_product_stocks.stock_value
, semi_finished_product_stocks.opening_date
, semi_finished_product_stocks.unit_id
, semi_finished_product_stocks.status
, semi_finished_product_stocks.created_at

    ";
        $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('users', 'users.id', '=', ', semi_finished_product_stocks.status.user_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method , semi_finished_product_stocks.status form
     * *****************************************************************************************************************
     */
    ...
    /**
     * *****************************************************************************************************************
     * @method , semi_finished_product_stocks.status store | Insert & Update
     * *****************************************************************************************************************
     */
