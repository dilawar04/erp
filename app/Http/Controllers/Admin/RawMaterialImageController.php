<?php
/**
 * Class RawMaterialImage
 * @property \App\RawMaterialImage $model
 */

namespace App\Http\Controllers\Admin;

use App\RawMaterialImage;
use Breadcrumb;
...
class RawMaterialImageController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'raw_material_images.' . $this->id_key])->merge(request()->query())->toArray();
...
, raw_material_images.created_at
    ...
    ";
        ...
        //$SQL = $SQL->leftJoin('users', 'users.id', '=', 'raw_material_images.user_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method raw_material_images form
     * *****************************************************************************************************************
     */
