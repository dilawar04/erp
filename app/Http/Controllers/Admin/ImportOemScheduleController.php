<?php
/**
 * Class ImportOemSchedule
 * @property \App\ImportOemSchedule $model
 */

namespace App\Http\Controllers\Admin;

use App\ImportOemSchedule;
use Breadcrumb;
...
class ImportOemScheduleController extends Controller
{
 ...
 /**
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'import_oem_schedules.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "import_oem_schedules.id
, import_oem_schedules.oem_id
-- , import_oem_schedules.oem_id
, import_oem_schedules.file
, import_oem_schedules.month
, import_oem_schedules.year
, import_oem_schedules.status

 ";
         $SQL = $this->model->select(\DB::raw($select));

        //$SQL = $SQL->leftJoin('oems', 'oems.id', '=', 'import_oem_schedules.oem_id');
    ...
    /**
     * *************************************************************************
     * @method import_oem_schedules form
     * *************************************************************************
     * 
     */
    ...
    /**
     * *************************************************************************
     * @method import_oem_schedules store | Insert & Update
     * *************************************************************************
     * 
     */
    ...
    public function store()
    {
       $id = request()->input($this->id_key);
          ...
          /** -------- Validation */
        $validator_rules = [
            'file' => 'mimes:pdf,xls,doc,docx,pptx,pps|max:20000',
            'month' => "required",
        ];
    ...
    /**
     * *************************************************************************
     * @method import_oem_schedules delete
     * *************************************************************************
     * 
     */
    ...
    /**
     * *************************************************************************
     * @method shift_overtimes view | Record
     * *************************************************************************
     * 
     */
    ...
    /**
     * *************************************************************************
     * @method shift_overtimes AJAX actions
     * *************************************************************************
     */
    function ajax()
    {
    ...
    /**
     * *****************************************************************************************************************
     * @method shift_overtimes duplicate
     * *****************************************************************************************************************
     */
