...
class MachineController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method machines index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'machines.' . $this->id_key])->merge(request()->query())->toArray();
...
, machines.warranty_type
, machines.warranty_expiry
...
, machines.created_at
    ...
    ";
        ...
        //$SQL = $SQL->leftJoin('machines', 'machines.id', '=', 'machines.machine_id');
                //$SQL = $SQL->leftJoin('workstations', 'workstations.id', '=', 'machines.workstation_id');
                /** -------- WHERE */
        $where = $this->where;
        //$select = $SQL;
    ...
    /**
     * *****************************************************************************************************************
     * @method machines store | Insert & Update
     * *****************************************************************************************************************
     */
