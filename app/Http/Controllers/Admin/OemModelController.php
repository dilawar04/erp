...
class OemModelController extends Controller
{
    ...
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'oem_models.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "oem_models.id
, oem_models.model_name
, oem_models.model_code
, oem_models.model_no
, oem_models.status
, oem_models.created_at
    ";
