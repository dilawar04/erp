<?php
/**
 * Class SemiFinishedProductImage
 * @property \App\SemiFinishedProductImage $model
 */

namespace App\Http\Controllers\Admin;

use App\SemiFinishedProductImage;
use Breadcrumb;
...
class SemiFinishedProductImageController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method departments index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'semi_finished_product_images.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "semi_finished_product_images.id
, semi_finished_product_images.schedule
, semi_finished_product_images.upload_date
, semi_finished_product_images.status
    ...
    /**
     * *****************************************************************************************************************
     * @method departments store | Insert & Update
     * *****************************************************************************************************************
     */
