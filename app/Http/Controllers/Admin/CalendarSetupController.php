...
/**
 * Class CalendarSetup
 * @property \App\CalendarSetup $model
 */
...
class CalendarSetupController extends Controller
{
    ...
    /**
     * *****************************************************************************************************************
     * @method calendar_setup index | Grid | listing
     * *****************************************************************************************************************
     */
    public function index()
    {
        ...
        /** -------- Pagination Config */
        $config = collect(['sort' => $this->id_key, 'dir' => 'desc', 'limit' => 25, 'group' => 'calendar_setup.' . $this->id_key])->merge(request()->query())->toArray();

        /** -------- Query */
        $select = "calendar_setup.id
, calendar_setup.week_starts_form
, calendar_setup.public_holiday_name
, calendar_setup.public_holiday_date
