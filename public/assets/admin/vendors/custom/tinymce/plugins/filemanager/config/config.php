...
*/
$l = 3;
$l += count(explode('/', str_replace('/assets/admin/vendors/custom/tinymce/plugins/filemanager/dialog.php', '', $_SERVER['SCRIPT_NAME'])));
$dir_tail = (count(explode('/', $_SERVER['HTTP_REFERER']))-$l);
if($dir_tail < 0) $dir_tail = 0;
...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => str_repeat('../', $dir_tail) . 'assets/uploads/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'access_keys' => array($_COOKIE['fm_access_key']),
