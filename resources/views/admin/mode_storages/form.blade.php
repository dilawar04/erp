                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control kt-select2" name="parent_id" id="parent_id">
                                        ...
                                        @php
                                            ...
                                            $_M->query = "SELECT * FROM `mode_storages` WHERE `status`='Active'";
                                            echo $_M->build();
                                        @endphp
                                    </select>
                                </div>
                            ...
                            <div class="clone_container">
                                ...
                                <div class="form-group row mb-3 clone">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="sub_mode_storages[{{ $clone->id }}]" id="sub_mode_storages" class="sub-dep form-control" placeholder="{{ __('Mode Type') }}" value="{{ old('sub_mode_storages.' . $key, $clone->title) }}" />
                                    </div>
                                    <div class="col-lg-6">
...
@section('scripts')
    <script>
        function add_more_cb(){
            $('.clone').last().find('.sub-dep').prop('name', 'sub_mode_storages[]');
        }

        $("form#mode_storages").validate({
