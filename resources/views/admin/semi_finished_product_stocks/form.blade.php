...
@section('content')
    <form action="{{ admin_url('store', true) }}" method="post" enctype="multipart/form-data" id="semi_finished_product_stocks">
...
@endsection {{-- Scripts --}} @section('scripts')
    <script>
         $(form#semi_finished_product_stocks).on('click', '.is_stations', function() {
            ...
            $(form#semi_finished_product_stocks).on('click', '#modal-submit-button', function() {
        ...
        $("form#semi_finished_product_stocks").validate({
