@php
            $status_column_data = DB_enumValues('machine_manuals', 'status');
...
<form action="{{ admin_url('', true) }}" method="get" enctype="multipart/form-data" id="machine_manuals-form">
    @csrf
    @include('admin.layouts.inc.stickybar', compact('form_buttons'))
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_machine_manuals">
                        ...
                        $grid->dt_column(['created_at' => ['width' => '150', 'align' => 'center', 'input_options' => ['class' => 'm_datepicker'],
                            'wrap' => function($value, $field, $_row, $grid) {
                                return _date_format($value, $_row, $field, $grid);
                                                ...
                                                $grid->dt_column(['file' => ['align' => 'center',
                            'wrap' => function($value, $field, $_row) use($_this) {
