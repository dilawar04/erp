...
<form action="{{ admin_url('store', true) }}" method="get" enctype="multipart/form-data" id="events-form">
    @csrf
    @include('admin.layouts.inc.stickybar', compact('form_buttons'))
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_full_calendar">
                    ...
                    <div class="kt-portlet__body kt-padding-0">
                        ...
                        $grid->dt_column(['status' => ['overflow' => 'initial', 'align' => 'center', 'th_align' => 'center', 'filter_value' => '=', ['options' => $grid->status_column_data, 'class' => '', 'onchange' => true],
                        ...
                        $grid->dt_column(['created_at' => ['width' => '150', 'align' => 'center', 'input_options' => ['class' => 'm_picker'],
                            'wrap' => function($value, $field, $_row, $grid) {
