...
@section('content')
<form action="{{ admin_url('store', true) }}" method="post" enctype="multipart/form-data" id="subscribers">
    @csrf
    ...
    <div class="row">
        ...
        <div class="form-group row">
                        <label for="email" class="col-lg-2 col-sm-12 col-form-label required">{{ __('Email') }}:</label>             <div class="col-lg-6">
...
<div class="kt-separator kt-separator--border-dashed kt-separator--space-md"></div>
        <div class="form-group row">
            <label for="status" class="col-lg-2 col-sm-12 col-form-label">{{ __('Status') }}:</label>
                    ...
                    {!! selectBox(DB_enumValues('subscribers', 'status'), old('status', $row->status)) !!}
                </select>
                                            </div>
        </div>
    <div class="kt-separator kt-separator--border-dashed kt-separator--space-md"></div>
