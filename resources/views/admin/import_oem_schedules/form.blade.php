...
@section('content')
    <form action="{{ admin_url('store', true) }}" method="post" enctype="multipart/form-data" id="import_oem_schedules">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-4">
                                    ...
                                    <select name="oem_id" id="oem_id" value="{{old('oem_id', $row->oem_id)}}" class="form-control m-select2">
                                        <option value="{{old('oem_id', $row->oem_id)}}">Select Oems</option>
...
@endsection {{-- Scripts --}} @section('scripts')
    ...
    $(this).datepicker('hide');
        ...
        $("form#import_oem_schedules").validate({
            ...
            /*messages: {
        'file' : {required: 'file is required',},'oem_id' : {required: 'Oems is required',},    },*/
