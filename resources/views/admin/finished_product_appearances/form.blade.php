...
@section('content')
    <form action="{{ admin_url('store', true) }}" method="post" enctype="multipart/form-data" id="finished_product_appearances">
...
@endsection {{-- Scripts --}} @section('scripts')
    <script>
         $(form#finished_product_appearances).on('click', '.is_stations', function() {
            ...
            $(form#finished_product_appearances).on('click', '#modal-submit-button', function() {
        ...
        $("form#finished_product_appearances").validate({
