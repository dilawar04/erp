@php
    $status_column_data = DB_enumValues('raw_material_dimensions', 'status');
...
@section('content')
    ...
    <form action="{{ admin_url('', true) }}" method="get" enctype="multipart/form-data" id="raw_material_dimensions-form">
        @csrf
