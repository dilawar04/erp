@php
    $status_column_data = DB_enumValues('pages', 'status');
...
@section('content')
    ...
    <form action="{{ admin_url('', true) }}" method="get" enctype="multipart/form-data" id="pages-form">
        @csrf
        @include('admin.layouts.inc.stickybar', compact('form_buttons'))
        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            <div class="row">
                <div class="col-lg-12">
                    <div class="kt-portlet" data-ktportlet="true" id="kt_portlet_pages">
                        ...
                        <div class="kt-portlet__body kt-padding-0">
                            @php
                                ...
                                $grid->dt_column(['url' => ['align' => 'center',
                                ...
                                $grid->dt_column(['thumbnail' => ['align' => 'center',
                                    'wrap' => function($value, $field, $row) use($_this) {
