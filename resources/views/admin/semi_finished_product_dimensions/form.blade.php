...
@section('content')
    <form action="{{ admin_url('store', true) }}" method="post" enctype="multipart/form-data" id="semi_finished_product_dimensions">
...
@endsection {{-- Scripts --}} @section('scripts')
    <script>
         $(form#semi_finished_product_dimensions).on('click', '.is_stations', function() {
            ...
            $(form#semi_finished_product_dimensions).on('click', '#modal-submit-button', function() {
        ...
        $("form#semi_finished_product_dimensions").validate({
