@php $form_buttons = ['save', 'view', 'delete', 'back']; @endphp @extends('admin.layouts.admin') @section('content')
    <form action="{{ admin_url('store', true) }}" method="post" enctype="multipart/form-data" id="workstation_operations">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="workstation_id" id="workstation_id" class="form-control m-select2">
                                        ...
                                        {!! selectBox("SELECT id,name FROM workstations", old('workstation_id', request('workstation_id') > 0 ? request('workstation_id') : $row->workstation_id)) !!}
                                    </select>
                                </div>
                            </div>
...
@endsection {{-- Scripts --}} @section('scripts')
    <script>
        $("form#workstation_operations").validate({
